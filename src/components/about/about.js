...
const About = () => {
  ...
  return (
    <section id="about" className="about black-bg flex-display about-section">
        ...
        <div className="about-section">
          <div className="about-left white-txt">
            ...
            <p className="content-para">
              Professional developers, designers and marketers working{" "}
            </p>
            <p className="content-para">
              together to provide finest blockchain solutions and marketing
            </p>
            <p className="content-para">services at economical prices.</p>
        ...
        <div className="work-section">
          ...
          <div className="work-content">
            <div className="content abs-position">
              ...
              <img className="line-top abs-position" src={lineIcon} alt="line"/>
            ...
            <div className="content2 abs-position">
              ...
              <img src={circleIcon} alt="circle"/>
              <img className="line-bot abs-position" src={lineIcon} alt="line"/>
