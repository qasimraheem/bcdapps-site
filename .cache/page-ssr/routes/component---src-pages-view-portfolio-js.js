exports.id = "component---src-pages-view-portfolio-js";
exports.ids = ["component---src-pages-view-portfolio-js"];
exports.modules = {

/***/ "./src/pages/viewPortfolio.js":
/*!************************************!*\
  !*** ./src/pages/viewPortfolio.js ***!
  \************************************/
/***/ (() => {
...
//         <button className="home-btn btn-folo" onClick={() => moveToHome()}>Home</button>
//       </div>
//     </div>
...
//            <svg className="mouse-svg" xmlns="http://www.w3.org/2000/svg" width="33" height="55" viewBox="0 0 33 55">
...
//           {projects.map((project,item) => <div className="white-border-one" v-bind:key={index}>
...
//               {/* <ul className="text-list" v-if="project.bullets && project.bullets.length"> */}
//                 {/* <li v-for="(bullet,index) in project.bullets" v-bind:key="index"><span className="dot-list"></span>{{bullet}}</li> */}
//               {/* </ul> */}
//               <div className="app-details" v-if="project.hasApp">
//                 {/* <a :href="project.playStoreLink" target="_blank"> */}
//                 {/* <img src={googlePlayImg} alt="play store"></a> */}
//               </div>
//             </div>
//             <div className="outer-border-svg">
//               <div className="ring-svg">
//                 <a className="visit-gander" /*:href="project.link"*/ target="_blank">Visit {{/*project.name*/}}</a>
//               </div>
//             </div>
//           </div>
//         // </div>
...
;
//# sourceMappingURL=component---src-pages-view-portfolio-js.js.map