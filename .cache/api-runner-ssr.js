var plugins = [{
      ...
      plugin: require('E:/Office work/bcdapps-web/node_modules/gatsby-plugin-google-analytics/gatsby-ssr'),
      ...
      plugin: require('E:/Office work/bcdapps-web/node_modules/gatsby-plugin-image/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      name: 'gatsby-plugin-react-helmet',
      plugin: require('E:/Office work/bcdapps-web/node_modules/gatsby-plugin-react-helmet/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      name: 'gatsby-plugin-sitemap',
      plugin: require('E:/Office work/bcdapps-web/node_modules/gatsby-plugin-sitemap/gatsby-ssr'),
      options: {"plugins":[],"output":"/sitemap","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]},
    },{
      name: 'gatsby-plugin-manifest',
      plugin: require('E:/Office work/bcdapps-web/node_modules/gatsby-plugin-manifest/gatsby-ssr'),
      ...
      plugin: require('E:/Office work/bcdapps-web/node_modules/gatsby-plugin-mdx/gatsby-ssr'),
